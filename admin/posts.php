...
<main class="admin col-md-9 ms-sm-auto col-lg-10 px-md-4 pt-5">
    ...
    <div class="container col-lg-6 pb-5">
        <div class="row">
            ...
            $post = request($conn, "SELECT content, pseudo, posts.id AS postID, posts.creationDate AS postDate FROM posts INNER JOIN user ON posts.userID = user.id ORDER BY postDate DESC");
